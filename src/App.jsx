      ...
      <Suspense fallback={<LoadingFallback />}>
        <Routes>
          ...
          <Route
            ...
            element={
              isLogin ? (
                ...
                <Navigate
                  to="/login"
                  state={{ from: "Own Status", message: "Login is required" }}
                />
              )
            }
          />
          ...
          <Route
            ...
            element={
              isLogin ? (
                ...
                <Navigate
                  to="/login"
                  state={{ from: "Add Page", message: "Login is required" }}
                />
              )
            }
          />
          <Route
            ...
            element={
              isLogin ? (
                ...
                <Navigate
                  to="/login"
                  state={{ from: "Profile", message: "Login is required" }}
                />
              )
            }
          />
          ...
          <Route
            ...
            element={isLogin ? <Home /> : <ForgotPass />}
          />
          <Route
            path="/verify-otp"
            element={isLogin ? <Home /> : <VerifyOtp />}
          />
          <Route
            path="/change-password"
            element={isLogin ? <Home /> : <ChangePassword />}
          />
