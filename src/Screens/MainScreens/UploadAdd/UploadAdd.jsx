...
function UploadPage() {
  ...
  let Plan = [
    { name: 'Basic', price: '300', duration: '6 Months', description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.' },
    { name: 'Personal', price: '500', duration: '12 Months', description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.' },
    { name: 'Business', price: '1000', duration: '24 Months', description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.' },
  ]
      ...
      <div className='mx-[80px] sm:mx-[10px] my-9'>
        ...
        <div className='grid grid-row-2'>
          ...
          <div className='grid grid-cols-3 sm:grid-cols-1 ,mdl:grid-cols-2 w-full  gap-7 '>
            {Plan.map((data) => (
              <div className='h-[500px] rounded-3xl '>
                  ...
                  <div className='text-white text-center mt-5'>
                    <div className='my-6'>
                      <img
                        ...
                        src="images/dd/img_frame_green_a700.svg"
                        alt="image_three" /> Lorem Ipsum is simply dummy</div>
                    <div className='my-5'><img
                      className='inline-block'
                      src="images/dd/img_frame_deep_orange_a400.svg"
                      alt="image_three" /> Lorem Ipsum is simply dummy</div>
                    <div className='my-5'><img
                      className='inline-block'
                      src="images/dd/img_frame_green_a700.svg"
