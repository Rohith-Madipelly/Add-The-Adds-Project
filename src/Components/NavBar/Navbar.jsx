  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-[60px]">
        ...
        >
<Link to={"/"} className="inline"><div className="inline flex" style={{ textAlign: 'center' }}><img src="images\Logo.png" alt="React Image" width={50} style={{ marginTop: 5, marginLeft: 30 }} /> <p className="m-3">Add The Adds.com</p></div></Link>
